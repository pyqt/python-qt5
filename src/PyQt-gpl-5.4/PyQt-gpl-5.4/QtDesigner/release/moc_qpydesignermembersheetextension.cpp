...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QPyDesignerMemberSheetExtension_t, stringdata) + ofs \
...
const QMetaObject QPyDesignerMemberSheetExtension::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QPyDesignerMemberSheetExtension.data,
      qt_meta_data_QPyDesignerMemberSheetExtension,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QPyDesignerMemberSheetExtension::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QPyDesignerMemberSheetExtension.stringdata))
