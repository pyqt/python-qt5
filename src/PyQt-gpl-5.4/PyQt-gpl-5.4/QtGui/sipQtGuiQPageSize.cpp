...
#include <qpagesize.h>
#line 29 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQPageSize.cpp"

#line 30 "sip/QtCore/qsize.sip"
#include <qsize.h>
#line 33 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQPageSize.cpp"
#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 36 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQPageSize.cpp"
#line 101 "sip/QtCore/qsize.sip"
#include <qsize.h>
#line 39 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQPageSize.cpp"
#line 30 "sip/QtCore/qrect.sip"
#include <qrect.h>
#line 42 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQPageSize.cpp"
#line 165 "sip/QtCore/qrect.sip"
#include <qrect.h>
#line 45 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQPageSize.cpp"
...
static sipEnumMemberDef enummembers_QPageSize[] = {
    {sipName_A0, static_cast<int>(QPageSize::A0), 177},
    {sipName_A1, static_cast<int>(QPageSize::A1), 177},
    {sipName_A10, static_cast<int>(QPageSize::A10), 177},
    {sipName_A2, static_cast<int>(QPageSize::A2), 177},
    {sipName_A3, static_cast<int>(QPageSize::A3), 177},
    {sipName_A3Extra, static_cast<int>(QPageSize::A3Extra), 177},
    {sipName_A4, static_cast<int>(QPageSize::A4), 177},
    {sipName_A4Extra, static_cast<int>(QPageSize::A4Extra), 177},
    {sipName_A4Plus, static_cast<int>(QPageSize::A4Plus), 177},
    {sipName_A4Small, static_cast<int>(QPageSize::A4Small), 177},
    {sipName_A5, static_cast<int>(QPageSize::A5), 177},
    {sipName_A5Extra, static_cast<int>(QPageSize::A5Extra), 177},
    {sipName_A6, static_cast<int>(QPageSize::A6), 177},
    {sipName_A7, static_cast<int>(QPageSize::A7), 177},
    {sipName_A8, static_cast<int>(QPageSize::A8), 177},
    {sipName_A9, static_cast<int>(QPageSize::A9), 177},
    {sipName_AnsiA, static_cast<int>(QPageSize::AnsiA), 177},
    {sipName_AnsiB, static_cast<int>(QPageSize::AnsiB), 177},
    {sipName_AnsiC, static_cast<int>(QPageSize::AnsiC), 177},
    {sipName_AnsiD, static_cast<int>(QPageSize::AnsiD), 177},
    {sipName_AnsiE, static_cast<int>(QPageSize::AnsiE), 177},
    {sipName_ArchA, static_cast<int>(QPageSize::ArchA), 177},
    {sipName_ArchB, static_cast<int>(QPageSize::ArchB), 177},
    {sipName_ArchC, static_cast<int>(QPageSize::ArchC), 177},
    {sipName_ArchD, static_cast<int>(QPageSize::ArchD), 177},
    {sipName_ArchE, static_cast<int>(QPageSize::ArchE), 177},
    {sipName_B0, static_cast<int>(QPageSize::B0), 177},
    {sipName_B1, static_cast<int>(QPageSize::B1), 177},
    {sipName_B10, static_cast<int>(QPageSize::B10), 177},
    {sipName_B2, static_cast<int>(QPageSize::B2), 177},
    {sipName_B3, static_cast<int>(QPageSize::B3), 177},
    {sipName_B4, static_cast<int>(QPageSize::B4), 177},
    {sipName_B5, static_cast<int>(QPageSize::B5), 177},
    {sipName_B5Extra, static_cast<int>(QPageSize::B5Extra), 177},
    {sipName_B6, static_cast<int>(QPageSize::B6), 177},
    {sipName_B7, static_cast<int>(QPageSize::B7), 177},
    {sipName_B8, static_cast<int>(QPageSize::B8), 177},
    {sipName_B9, static_cast<int>(QPageSize::B9), 177},
    {sipName_C5E, static_cast<int>(QPageSize::C5E), 177},
    {sipName_Cicero, static_cast<int>(QPageSize::Cicero), 179},
    {sipName_Comm10E, static_cast<int>(QPageSize::Comm10E), 177},
    {sipName_Custom, static_cast<int>(QPageSize::Custom), 177},
    {sipName_DLE, static_cast<int>(QPageSize::DLE), 177},
    {sipName_Didot, static_cast<int>(QPageSize::Didot), 179},
    {sipName_DoublePostcard, static_cast<int>(QPageSize::DoublePostcard), 177},
    {sipName_Envelope10, static_cast<int>(QPageSize::Envelope10), 177},
    {sipName_Envelope11, static_cast<int>(QPageSize::Envelope11), 177},
    {sipName_Envelope12, static_cast<int>(QPageSize::Envelope12), 177},
    {sipName_Envelope14, static_cast<int>(QPageSize::Envelope14), 177},
    {sipName_Envelope9, static_cast<int>(QPageSize::Envelope9), 177},
    {sipName_EnvelopeB4, static_cast<int>(QPageSize::EnvelopeB4), 177},
    {sipName_EnvelopeB5, static_cast<int>(QPageSize::EnvelopeB5), 177},
    {sipName_EnvelopeB6, static_cast<int>(QPageSize::EnvelopeB6), 177},
    {sipName_EnvelopeC0, static_cast<int>(QPageSize::EnvelopeC0), 177},
    {sipName_EnvelopeC1, static_cast<int>(QPageSize::EnvelopeC1), 177},
    {sipName_EnvelopeC2, static_cast<int>(QPageSize::EnvelopeC2), 177},
    {sipName_EnvelopeC3, static_cast<int>(QPageSize::EnvelopeC3), 177},
    {sipName_EnvelopeC4, static_cast<int>(QPageSize::EnvelopeC4), 177},
    {sipName_EnvelopeC5, static_cast<int>(QPageSize::EnvelopeC5), 177},
    {sipName_EnvelopeC6, static_cast<int>(QPageSize::EnvelopeC6), 177},
    {sipName_EnvelopeC65, static_cast<int>(QPageSize::EnvelopeC65), 177},
    {sipName_EnvelopeC7, static_cast<int>(QPageSize::EnvelopeC7), 177},
    {sipName_EnvelopeChou3, static_cast<int>(QPageSize::EnvelopeChou3), 177},
    {sipName_EnvelopeChou4, static_cast<int>(QPageSize::EnvelopeChou4), 177},
    {sipName_EnvelopeDL, static_cast<int>(QPageSize::EnvelopeDL), 177},
    {sipName_EnvelopeInvite, static_cast<int>(QPageSize::EnvelopeInvite), 177},
    {sipName_EnvelopeItalian, static_cast<int>(QPageSize::EnvelopeItalian), 177},
    {sipName_EnvelopeKaku2, static_cast<int>(QPageSize::EnvelopeKaku2), 177},
    {sipName_EnvelopeKaku3, static_cast<int>(QPageSize::EnvelopeKaku3), 177},
    {sipName_EnvelopeMonarch, static_cast<int>(QPageSize::EnvelopeMonarch), 177},
    {sipName_EnvelopePersonal, static_cast<int>(QPageSize::EnvelopePersonal), 177},
    {sipName_EnvelopePrc1, static_cast<int>(QPageSize::EnvelopePrc1), 177},
    {sipName_EnvelopePrc10, static_cast<int>(QPageSize::EnvelopePrc10), 177},
    {sipName_EnvelopePrc2, static_cast<int>(QPageSize::EnvelopePrc2), 177},
    {sipName_EnvelopePrc3, static_cast<int>(QPageSize::EnvelopePrc3), 177},
    {sipName_EnvelopePrc4, static_cast<int>(QPageSize::EnvelopePrc4), 177},
    {sipName_EnvelopePrc5, static_cast<int>(QPageSize::EnvelopePrc5), 177},
    {sipName_EnvelopePrc6, static_cast<int>(QPageSize::EnvelopePrc6), 177},
    {sipName_EnvelopePrc7, static_cast<int>(QPageSize::EnvelopePrc7), 177},
    {sipName_EnvelopePrc8, static_cast<int>(QPageSize::EnvelopePrc8), 177},
    {sipName_EnvelopePrc9, static_cast<int>(QPageSize::EnvelopePrc9), 177},
    {sipName_EnvelopeYou4, static_cast<int>(QPageSize::EnvelopeYou4), 177},
    {sipName_ExactMatch, static_cast<int>(QPageSize::ExactMatch), 178},
    {sipName_Executive, static_cast<int>(QPageSize::Executive), 177},
    {sipName_ExecutiveStandard, static_cast<int>(QPageSize::ExecutiveStandard), 177},
    {sipName_FanFoldGerman, static_cast<int>(QPageSize::FanFoldGerman), 177},
    {sipName_FanFoldGermanLegal, static_cast<int>(QPageSize::FanFoldGermanLegal), 177},
    {sipName_FanFoldUS, static_cast<int>(QPageSize::FanFoldUS), 177},
    {sipName_Folio, static_cast<int>(QPageSize::Folio), 177},
    {sipName_FuzzyMatch, static_cast<int>(QPageSize::FuzzyMatch), 178},
    {sipName_FuzzyOrientationMatch, static_cast<int>(QPageSize::FuzzyOrientationMatch), 178},
    {sipName_Imperial10x11, static_cast<int>(QPageSize::Imperial10x11), 177},
    {sipName_Imperial10x13, static_cast<int>(QPageSize::Imperial10x13), 177},
    {sipName_Imperial10x14, static_cast<int>(QPageSize::Imperial10x14), 177},
    {sipName_Imperial12x11, static_cast<int>(QPageSize::Imperial12x11), 177},
    {sipName_Imperial15x11, static_cast<int>(QPageSize::Imperial15x11), 177},
    {sipName_Imperial7x9, static_cast<int>(QPageSize::Imperial7x9), 177},
    {sipName_Imperial8x10, static_cast<int>(QPageSize::Imperial8x10), 177},
    {sipName_Imperial9x11, static_cast<int>(QPageSize::Imperial9x11), 177},
    {sipName_Imperial9x12, static_cast<int>(QPageSize::Imperial9x12), 177},
    {sipName_Inch, static_cast<int>(QPageSize::Inch), 179},
    {sipName_JisB0, static_cast<int>(QPageSize::JisB0), 177},
    {sipName_JisB1, static_cast<int>(QPageSize::JisB1), 177},
    {sipName_JisB10, static_cast<int>(QPageSize::JisB10), 177},
    {sipName_JisB2, static_cast<int>(QPageSize::JisB2), 177},
    {sipName_JisB3, static_cast<int>(QPageSize::JisB3), 177},
    {sipName_JisB4, static_cast<int>(QPageSize::JisB4), 177},
    {sipName_JisB5, static_cast<int>(QPageSize::JisB5), 177},
    {sipName_JisB6, static_cast<int>(QPageSize::JisB6), 177},
    {sipName_JisB7, static_cast<int>(QPageSize::JisB7), 177},
    {sipName_JisB8, static_cast<int>(QPageSize::JisB8), 177},
    {sipName_JisB9, static_cast<int>(QPageSize::JisB9), 177},
    {sipName_LastPageSize, static_cast<int>(QPageSize::LastPageSize), 177},
    {sipName_Ledger, static_cast<int>(QPageSize::Ledger), 177},
    {sipName_Legal, static_cast<int>(QPageSize::Legal), 177},
    {sipName_LegalExtra, static_cast<int>(QPageSize::LegalExtra), 177},
    {sipName_Letter, static_cast<int>(QPageSize::Letter), 177},
    {sipName_LetterExtra, static_cast<int>(QPageSize::LetterExtra), 177},
    {sipName_LetterPlus, static_cast<int>(QPageSize::LetterPlus), 177},
    {sipName_LetterSmall, static_cast<int>(QPageSize::LetterSmall), 177},
    {sipName_Millimeter, static_cast<int>(QPageSize::Millimeter), 179},
    {sipName_NPageSize, static_cast<int>(QPageSize::NPageSize), 177},
    {sipName_NPaperSize, static_cast<int>(QPageSize::NPaperSize), 177},
    {sipName_Note, static_cast<int>(QPageSize::Note), 177},
    {sipName_Pica, static_cast<int>(QPageSize::Pica), 179},
    {sipName_Point, static_cast<int>(QPageSize::Point), 179},
    {sipName_Postcard, static_cast<int>(QPageSize::Postcard), 177},
    {sipName_Prc16K, static_cast<int>(QPageSize::Prc16K), 177},
    {sipName_Prc32K, static_cast<int>(QPageSize::Prc32K), 177},
    {sipName_Prc32KBig, static_cast<int>(QPageSize::Prc32KBig), 177},
    {sipName_Quarto, static_cast<int>(QPageSize::Quarto), 177},
    {sipName_Statement, static_cast<int>(QPageSize::Statement), 177},
    {sipName_SuperA, static_cast<int>(QPageSize::SuperA), 177},
    {sipName_SuperB, static_cast<int>(QPageSize::SuperB), 177},
    {sipName_Tabloid, static_cast<int>(QPageSize::Tabloid), 177},
    {sipName_TabloidExtra, static_cast<int>(QPageSize::TabloidExtra), 177},
};
