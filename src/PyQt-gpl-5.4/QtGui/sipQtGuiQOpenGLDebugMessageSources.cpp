...
#line 29 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQOpenGLDebugMessageSources.cpp"

#line 35 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\sip/QtGui/qopengldebug.sip"
#include <qopengldebug.h>
#line 33 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQOpenGLDebugMessageSources.cpp"
...
#line 51 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQOpenGLDebugMessageSources.cpp"
...
#line 81 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQOpenGLDebugMessageSources.cpp"
...
#line 109 "sip/QtCore/qglobal.sip"
        sipRes = (sipCpp->operator QOpenGLDebugMessage::Sources::Int() == a0->operator QOpenGLDebugMessage::Sources::Int());
#line 117 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQOpenGLDebugMessageSources.cpp"
            sipReleaseType(const_cast<QOpenGLDebugMessage::Sources *>(a0),sipType_QOpenGLDebugMessage_Sources,a0State);
...
static PyObject *slot_QOpenGLDebugMessage_Sources___xor__(PyObject *sipArg0,PyObject *sipArg1)
{
...

    {
        ...
        if (sipParsePair(&sipParseErr, sipArg0, sipArg1, "J1J1", sipType_QOpenGLDebugMessage_Sources, &a0, &a0State, sipType_QOpenGLDebugMessage_Sources, &a1, &a1State))
        {
            QOpenGLDebugMessage::Sources*sipRes;
...

    {
        ...
        if (sipParsePair(&sipParseErr, sipArg0, sipArg1, "J1i", sipType_QOpenGLDebugMessage_Sources, &a0, &a0State, &a1))
        {
            QOpenGLDebugMessage::Sources*sipRes = 0;

#line 103 "sip/QtCore/qglobal.sip"
        sipRes = new QOpenGLDebugMessage::Sources(*a0 ^ a1);
#line 220 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQOpenGLDebugMessageSources.cpp"
            sipReleaseType(a0,sipType_QOpenGLDebugMessage_Sources,a0State);
...
#line 98 "sip/QtCore/qglobal.sip"
        sipRes = new QOpenGLDebugMessage::Sources(*a0 | a1);
#line 270 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQOpenGLDebugMessageSources.cpp"
            sipReleaseType(a0,sipType_QOpenGLDebugMessage_Sources,a0State);
...
extern "C" {static void *cast_QOpenGLDebugMessage_Sources(void *, const sipTypeDef *);}
static void *cast_QOpenGLDebugMessage_Sources(void *ptr, const sipTypeDef *targetType)
{
    if (targetType == sipType_QOpenGLDebugMessage_Sources)
        return ptr;
...
extern "C" {static void assign_QOpenGLDebugMessage_Sources(void *, SIP_SSIZE_T, const void *);}
static void assign_QOpenGLDebugMessage_Sources(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast<QOpenGLDebugMessage::Sources *>(sipDst)[sipDstIdx] = *reinterpret_cast<const QOpenGLDebugMessage::Sources *>(sipSrc);
}
...
return 0;
#line 547 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQOpenGLDebugMessageSources.cpp"
}
...
PyDoc_STRVAR(doc_QOpenGLDebugMessage_Sources, "\1QOpenGLDebugMessage.Sources(QOpenGLDebugMessage.Sources)\n"
    "QOpenGLDebugMessage.Sources(int)\n"
    "QOpenGLDebugMessage.Sources()");


pyqt5ClassTypeDef sipTypeDef_QtGui_QOpenGLDebugMessage_Sources = {
{
    {
        -1,
        0,
    ...
    cast_QOpenGLDebugMessage_Sources,
