...
#line 29 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQOpenGLDebugMessage.cpp"

#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.4\\PyQt-gpl-5.4\\QtGui/sipQtGuiQOpenGLDebugMessage.cpp"
...
static sipEnumMemberDef enummembers_QOpenGLDebugMessage[] = {
    ...
    {sipName_DeprecatedBehaviorType, static_cast<int>(QOpenGLDebugMessage::DeprecatedBehaviorType), 137},
    {sipName_ErrorType, static_cast<int>(QOpenGLDebugMessage::ErrorType), 137},
    {sipName_GroupPopType, static_cast<int>(QOpenGLDebugMessage::GroupPopType), 137},
    {sipName_GroupPushType, static_cast<int>(QOpenGLDebugMessage::GroupPushType), 137},
    {sipName_HighSeverity, static_cast<int>(QOpenGLDebugMessage::HighSeverity), 134},
    {sipName_InvalidSeverity, static_cast<int>(QOpenGLDebugMessage::InvalidSeverity), 134},
    {sipName_InvalidSource, static_cast<int>(QOpenGLDebugMessage::InvalidSource), 135},
    {sipName_InvalidType, static_cast<int>(QOpenGLDebugMessage::InvalidType), 137},
    {sipName_LowSeverity, static_cast<int>(QOpenGLDebugMessage::LowSeverity), 134},
    {sipName_MarkerType, static_cast<int>(QOpenGLDebugMessage::MarkerType), 137},
    {sipName_MediumSeverity, static_cast<int>(QOpenGLDebugMessage::MediumSeverity), 134},
    {sipName_NotificationSeverity, static_cast<int>(QOpenGLDebugMessage::NotificationSeverity), 134},
    {sipName_OtherSource, static_cast<int>(QOpenGLDebugMessage::OtherSource), 135},
    {sipName_OtherType, static_cast<int>(QOpenGLDebugMessage::OtherType), 137},
    {sipName_PerformanceType, static_cast<int>(QOpenGLDebugMessage::PerformanceType), 137},
    {sipName_PortabilityType, static_cast<int>(QOpenGLDebugMessage::PortabilityType), 137},
    {sipName_ShaderCompilerSource, static_cast<int>(QOpenGLDebugMessage::ShaderCompilerSource), 135},
    {sipName_ThirdPartySource, static_cast<int>(QOpenGLDebugMessage::ThirdPartySource), 135},
    {sipName_UndefinedBehaviorType, static_cast<int>(QOpenGLDebugMessage::UndefinedBehaviorType), 137},
    {sipName_WindowSystemSource, static_cast<int>(QOpenGLDebugMessage::WindowSystemSource), 135},
};
