...
#include "../../qpy/QtDesigner/qpydesignercontainerextension.h"
...
struct qt_meta_stringdata_QPyDesignerContainerExtension_t {
    QByteArrayData data[1];
    char stringdata[30];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QPyDesignerContainerExtension_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QPyDesignerContainerExtension_t qt_meta_stringdata_QPyDesignerContainerExtension = {
    {
QT_MOC_LITERAL(0, 0, 29) // "QPyDesignerContainerExtension"
...
void QPyDesignerContainerExtension::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject QPyDesignerContainerExtension::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QPyDesignerContainerExtension.data,
      qt_meta_data_QPyDesignerContainerExtension,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QPyDesignerContainerExtension::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QPyDesignerContainerExtension.stringdata))
