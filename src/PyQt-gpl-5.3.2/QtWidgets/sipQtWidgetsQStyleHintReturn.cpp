...
#line 29 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.3.2\\QtWidgets/sipQtWidgetsQStyleHintReturn.cpp"
...
static sipEnumMemberDef enummembers_QStyleHintReturn[] = {
    {sipName_SH_Default, static_cast<int>(QStyleHintReturn::SH_Default), 298},
    {sipName_SH_Mask, static_cast<int>(QStyleHintReturn::SH_Mask), 298},
    {sipName_SH_Variant, static_cast<int>(QStyleHintReturn::SH_Variant), 298},
    {sipName_Type, static_cast<int>(QStyleHintReturn::Type), 299},
    {sipName_Version, static_cast<int>(QStyleHintReturn::Version), 300},
};
