...
#line 29 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.3.2\\QtWidgets/sipQtWidgetsQScrollerProperties.cpp"

#line 30 "sip/QtCore/qvariant.sip"
#include <qvariant.h>
#line 33 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.3.2\\QtWidgets/sipQtWidgetsQScrollerProperties.cpp"
...
static sipEnumMemberDef enummembers_QScrollerProperties[] = {
    {sipName_AcceleratingFlickMaximumTime, static_cast<int>(QScrollerProperties::AcceleratingFlickMaximumTime), 263},
    {sipName_AcceleratingFlickSpeedupFactor, static_cast<int>(QScrollerProperties::AcceleratingFlickSpeedupFactor), 263},
    {sipName_AxisLockThreshold, static_cast<int>(QScrollerProperties::AxisLockThreshold), 263},
    {sipName_DecelerationFactor, static_cast<int>(QScrollerProperties::DecelerationFactor), 263},
    {sipName_DragStartDistance, static_cast<int>(QScrollerProperties::DragStartDistance), 263},
    {sipName_DragVelocitySmoothingFactor, static_cast<int>(QScrollerProperties::DragVelocitySmoothingFactor), 263},
    {sipName_Fps20, static_cast<int>(QScrollerProperties::Fps20), 261},
    {sipName_Fps30, static_cast<int>(QScrollerProperties::Fps30), 261},
    {sipName_Fps60, static_cast<int>(QScrollerProperties::Fps60), 261},
    {sipName_FrameRate, static_cast<int>(QScrollerProperties::FrameRate), 263},
    {sipName_HorizontalOvershootPolicy, static_cast<int>(QScrollerProperties::HorizontalOvershootPolicy), 263},
    {sipName_MaximumClickThroughVelocity, static_cast<int>(QScrollerProperties::MaximumClickThroughVelocity), 263},
    {sipName_MaximumVelocity, static_cast<int>(QScrollerProperties::MaximumVelocity), 263},
    {sipName_MinimumVelocity, static_cast<int>(QScrollerProperties::MinimumVelocity), 263},
    {sipName_MousePressEventDelay, static_cast<int>(QScrollerProperties::MousePressEventDelay), 263},
    {sipName_OvershootAlwaysOff, static_cast<int>(QScrollerProperties::OvershootAlwaysOff), 262},
    {sipName_OvershootAlwaysOn, static_cast<int>(QScrollerProperties::OvershootAlwaysOn), 262},
    {sipName_OvershootDragDistanceFactor, static_cast<int>(QScrollerProperties::OvershootDragDistanceFactor), 263},
    {sipName_OvershootDragResistanceFactor, static_cast<int>(QScrollerProperties::OvershootDragResistanceFactor), 263},
    {sipName_OvershootScrollDistanceFactor, static_cast<int>(QScrollerProperties::OvershootScrollDistanceFactor), 263},
    {sipName_OvershootScrollTime, static_cast<int>(QScrollerProperties::OvershootScrollTime), 263},
    {sipName_OvershootWhenScrollable, static_cast<int>(QScrollerProperties::OvershootWhenScrollable), 262},
    {sipName_ScrollMetricCount, static_cast<int>(QScrollerProperties::ScrollMetricCount), 263},
    {sipName_ScrollingCurve, static_cast<int>(QScrollerProperties::ScrollingCurve), 263},
    {sipName_SnapPositionRatio, static_cast<int>(QScrollerProperties::SnapPositionRatio), 263},
    {sipName_SnapTime, static_cast<int>(QScrollerProperties::SnapTime), 263},
    {sipName_Standard, static_cast<int>(QScrollerProperties::Standard), 261},
    {sipName_VerticalOvershootPolicy, static_cast<int>(QScrollerProperties::VerticalOvershootPolicy), 263},
};
