...
#line 42 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.3.2\\sip/QtSensors/qambienttemperaturesensor.sip"
#include <qambienttemperaturesensor.h>
#line 29 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.3.2\\QtSensors/sipQtSensorsQAmbientTemperatureFilter.cpp"

#line 28 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.3.2\\sip/QtSensors/qambienttemperaturesensor.sip"
#include <qambienttemperaturesensor.h>
#line 33 "C:\\Users\\marcus\\Downloads\\PyQt-gpl-5.3.2\\QtSensors/sipQtSensorsQAmbientTemperatureFilter.cpp"
...
bool sipQAmbientTemperatureFilter::filter(QAmbientTemperatureReading*a0)
{
    ...
    extern bool sipVH_QtSensors_13(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, QAmbientTemperatureReading*);

    return sipVH_QtSensors_13(sipGILState, 0, sipPySelf, sipMeth, a0);
}


PyDoc_STRVAR(doc_QAmbientTemperatureFilter_filter, "QAmbientTemperatureFilter.filter(QAmbientTemperatureReading) -> bool");
...
static void *cast_QAmbientTemperatureFilter(void *ptr, const sipTypeDef *targetType)
{
    void *res;

    if (targetType == sipType_QAmbientTemperatureFilter)
        return ptr;

    if ((res = ((const sipClassTypeDef *)sipType_QSensorFilter)->ctd_cast((QSensorFilter *)(QAmbientTemperatureFilter *)ptr,targetType)) != NULL)
        return res;
...
static void dealloc_QAmbientTemperatureFilter(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QAmbientTemperatureFilter(sipGetAddress(sipSelf),sipSelf->flags);
    }
}
...
static sipEncodedTypeDef supers_QAmbientTemperatureFilter[] = {{50, 255, 1}};
...
pyqt5ClassTypeDef sipTypeDef_QtSensors_QAmbientTemperatureFilter = {
{
    {
        -1,
        0,
