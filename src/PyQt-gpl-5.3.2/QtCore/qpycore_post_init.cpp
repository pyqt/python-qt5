...
#if PY_MAJOR_VERSION >= 3
    PyObject *sip_flags = PyUnicode_FromString("-x VendorID -t WS_WIN -t Qt_5_3_2 -x PyQt_Desktop_OpenGL -x Py_v3");
#else
    PyObject *sip_flags = PyString_FromString("-x VendorID -t WS_WIN -t Qt_5_3_2 -x PyQt_Desktop_OpenGL -x Py_v3");
#endif
